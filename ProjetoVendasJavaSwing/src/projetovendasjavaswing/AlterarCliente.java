...
public class AlterarCliente extends javax.swing.JFrame {
    ...
    public AlterarCliente(Cliente cliente) {
        ...
        jTextField2.setText(this.clienteAlterar.getCpf());
        jTextField1.setText(this.clienteAlterar.getNome());
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Alteração de Cliente", jPanel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            clienteAlterar.setCpf(jTextField2.getText());
            clienteAlterar.setNome(jTextField1.getText());
            RepositorioClienteOdbc.obterInstancia().atualizar(clienteAlterar);
